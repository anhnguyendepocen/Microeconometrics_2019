...
Now we proceed to do the same for the unemployed: We collect the
infromation in each variable following the position. We take the people
that the labor employment status is unemployment and that has
information on the duration. Then we convert the information to montly
data.
